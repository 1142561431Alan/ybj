package com.ntsybj.common.utils;
...
public class PdfUtils {
     ...
     * @return
     */
    public  static PdfPTable createCellByHeight(String value, Font font, int height,PdfPTable table,boolean horizontal , boolean vertical) {
        PdfPCell cell = new PdfPCell();
        if(vertical) cell.setVerticalAlignment(Element.ALIGN_MIDDLE);//设置垂直居中
        if(horizontal) cell.setHorizontalAlignment(Element.ALIGN_CENTER);//设置水平居中
        cell.setPhrase(new Phrase(value, font));
